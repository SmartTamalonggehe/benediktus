        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Data @yield('judul') <span id="idProdi" data-id="{{ $prodi->id }}">{{ $prodi->nm_prodi }}</span></h4>
...
@section('js')
    ...
    $(document).ready(function(){
        ...
        if (semester_ak=="GENAP") {
            for (let i = tahun-1; i > tahun - 3; i--) {
                $('#tahun_ak').append('<option value="' + i + '">' + i + '</option>');
            }
            $('.tahun_ak').val(tahun-1).trigger('change');
        }else {
            for (let j = tahun; j > tahun - 3; j--) {
                $('#tahun_ak').append('<option value="' + j + '">' + j + '</option>');
            }
