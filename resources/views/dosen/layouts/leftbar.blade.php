    ...
    <div class="h-100">
        ...
        <div class="user-wid text-center py-4">
            ...
            <div class="mt-3">
                ...
                <a href="#" class="text-dark font-weight-medium font-size-16">{{ auth()->user()->dosen->nm_dosen }}</a>
                <p class="text-body mt-1 mb-0 font-size-13">Dosen {{ auth()->user()->dosen->prodi->nm_prodi }}</p>
